...
The plot shows that the max temperature is higher in July than January across all years and there is variation from year to year. Adding the geom_smooth function shows that max temperature has increased since 1980 in January and July. There were no observable extreme outliers. 
